...
```html
<link rel="stylesheet" href="3ilAppBase01/Web/bower_components/angular-notification-icons/angular-notification-icons.min.css">

<script src="3ilAppBase01/Web/bower_components/angular/angular.js"></script>
<script src="3ilAppBase01/Web/bower_components/angular-animate/angular-animate.js"></script> <!-- Not required, but recommended -->
<script src="3ilAppBase01/Web/bower_components/angular-notification-icons/angular-notification-icons.min.js"></script>
```
