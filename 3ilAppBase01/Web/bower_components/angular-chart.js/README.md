...
```html
<head>
  <link rel="stylesheet" href="3ilAppBase01/Web/bower_components/angular-chart.js/dist/angular-chart.css" />
<head>
<body>
  ...
</body>
  <script src="3ilAppBase01/Web/bower_components/angular/angular.min.js"></script>
  <script src="3ilAppBase01/Web/bower_components/Chart.js/Chart.min.js"></script>
  <script src="3ilAppBase01/Web/bower_components/angular-chart.js/dist/angular-chart.min.js"></script>
```
