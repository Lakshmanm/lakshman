        ...
        resolve: { // Any property in resolve should return a promise and is executed before the view is loaded
          loadOcModal: ['$ocLazyLoad', '$injector', '$rootScope', function($ocLazyLoad, $injector, $rootScope) {
            ...
            return $ocLazyLoad.load([
                '3ilAppBase01/Web/bower_components/bootstrap/dist/css/bootstrap.css', // will use the cached version if you already loaded bootstrap with the button
                '3ilAppBase01/Web/bower_components/ocModal/dist/css/ocModal.animations.css',
                '3ilAppBase01/Web/bower_components/ocModal/dist/css/ocModal.light.css',
                '3ilAppBase01/Web/bower_components/ocModal/dist/ocModal.js',
                'partials/modal.html'
              ]).then(function() {
