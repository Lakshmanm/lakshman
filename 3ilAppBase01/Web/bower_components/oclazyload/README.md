...
```js
$ocLazyLoad.load(['testModule.js', '3ilAppBase01/Web/bower_components/bootstrap/dist/js/bootstrap.js', 'anotherModule.js']);
```
...
$ocLazyLoad.load([
	...
	'3ilAppBase01/Web/bower_components/bootstrap/dist/css/bootstrap.css',
...
```js
$ocLazyLoad.load([{
  files: ['testModule.js', '3ilAppBase01/Web/bower_components/bootstrap/dist/js/bootstrap.js'],
  cache: false
},{
...
```js
$ocLazyLoad.load(
  ['testModule.js', '3ilAppBase01/Web/bower_components/bootstrap/dist/js/bootstrap.js', 'anotherModule.js'],
  {cache: false}
);
```
...
$ocLazyLoad.load({
	serie: true,
	files: [
		'3ilAppBase01/Web/bower_components/angular-strap/dist/angular-strap.js',
		'3ilAppBase01/Web/bower_components/angular-strap/dist/angular-strap.tpl.js'
	]
});
```
...
$ocLazyLoad.load({
	...
	files: ['3ilAppBase01/Web/bower_components/bootstrap/dist/css/bootstrap.css']
});
```
