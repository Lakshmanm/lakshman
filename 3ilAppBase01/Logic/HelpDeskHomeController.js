'use strict';
var app = angular.module('Aarush.HelpDeskHome', []);
app.controller('Aarush.HelpDeskHomeController', function ($scope,$state, $filter,TempDataService,$rootScope) {
   ...
   /// alert();
    ...
    $scope.edit=function(object){
       // alert(JSON.stringify(object));
        // $scope.org = object;
        $rootScope.orgProfile = object;
       // alert(JSON.stringify($rootScope.orgProfile));
        $state.go("app.HelpDeskconfirmtion");
