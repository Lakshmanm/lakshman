'use strict';
var app = angular.module('Aarush.HelpDeskconfirmtion', []);
app.controller('Aarush.HelpDeskconfirmtion', function ($scope, $filter,TempDataService,$rootScope,$state) {
    
$scope.orgProfile =$rootScope.orgProfile ;
